    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Kelola informasi akun pengguna</p>
            </div>
            <a href="/admin" class="btn btn-outline-secondary">Kembali</a>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="fw-semibold">{{ $user->tinggi_badan ?? '-' }} cm</div>
                        </div>

                        <div class="mb-3">
                            <small class="text-muted">Target Berat</small>
                            <div class="fw-semibold">{{ $user->target_berat ?? '-' }} kg</div>
                        </div>

                        <div class="mb-3">
                            <small class="text-muted">Aktivitas</small>
                            <div class="fw-semibold">{{ $user->aktivitas ?? '-' }}</div>
                        </div>

                        <div>
                            <small class="text-muted">Berat Terakhir</small>
